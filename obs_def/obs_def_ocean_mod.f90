...
!SATELLITE_BLENDED_SST,         KIND_TEMPERATURE,           COMMON_CODE
!SATELLITE_SSH,                 KIND_SEA_SURFACE_HEIGHT,    COMMON_CODE
!SATELLITE_SSS,                 KIND_SALINITY,              COMMON_CODE
!J1_SEA_SURFACE_ANOMALY,        KIND_SEA_SURFACE_ANOMALY,   COMMON_CODE
!EN_SEA_SURFACE_ANOMALY,        KIND_SEA_SURFACE_ANOMALY,   COMMON_CODE
!GFO_SEA_SURFACE_ANOMALY,       KIND_SEA_SURFACE_ANOMALY,   COMMON_CODE
