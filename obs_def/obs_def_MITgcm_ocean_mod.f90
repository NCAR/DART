...
!TMI_SEA_SURFACE_TEMPERATURE,   KIND_TEMPERATURE
...
!         case(SALINITY, GLIDER_SALINITY)
!            call interpolate(state, location, KIND_SALINITY, obs_val, istatus)
!         case(TEMPERATURE, GLIDER_TEMPERATURE, TMI_SEA_SURFACE_TEMPERATURE )
!            call interpolate(state, location, KIND_TEMPERATURE, obs_val, istatus)
!         case(U_CURRENT_COMPONENT, ADCP_U_CURRENT_COMPONENT, DRIFTER_U_CURRENT_COMPONENT)
!            call interpolate(state, location, KIND_U_WIND_COMPONENT, obs_val, istatus)
!         case(V_CURRENT_COMPONENT, ADCP_V_CURRENT_COMPONENT, DRIFTER_V_CURRENT_COMPONENT)
...
! case(SALINITY, TEMPERATURE, U_CURRENT_COMPONENT, V_CURRENT_COMPONENT, SEA_SURFACE_HEIGHT, &
!      ADCP_U_CURRENT_COMPONENT, ADCP_V_CURRENT_COMPONENT, &
!      DRIFTER_U_CURRENT_COMPONENT, DRIFTER_V_CURRENT_COMPONENT,&
!      GLIDER_SALINITY, GLIDER_TEMPERATURE, TMI_SEA_SURFACE_TEMPERATURE )
! continue
