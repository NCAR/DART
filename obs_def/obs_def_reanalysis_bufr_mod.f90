...
!MARINE_SFC_SPEC_HUMIDITY,    KIND_SPECIFIC_HUMIDITY
...
!LAND_SFC_SPEC_HUMIDITY,      KIND_SPECIFIC_HUMIDITY
...
!         case(RADIOSONDE_SPECIFIC_HUMIDITY, MARINE_SFC_SPEC_HUMIDITY, &
!              LAND_SFC_SPEC_HUMIDITY)
...
!   AIRCRAFT_TEMPERATURE, ACARS_U_WIND_COMPONENT, ACARS_V_WIND_COMPONENT, &
!   ACARS_TEMPERATURE, MARINE_SFC_U_WIND_COMPONENT, MARINE_SFC_V_WIND_COMPONENT, &
!   MARINE_SFC_TEMPERATURE, MARINE_SFC_SPEC_HUMIDITY,  LAND_SFC_U_WIND_COMPONENT, &
!   LAND_SFC_V_WIND_COMPONENT, LAND_SFC_TEMPERATURE, LAND_SFC_SPEC_HUMIDITY, &
!   SAT_U_WIND_COMPONENT, SAT_V_WIND_COMPONENT, ATOV_TEMPERATURE)
!      continue
