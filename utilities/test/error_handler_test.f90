...
!
! $Id: error_handler_test.f90 6256 2013-06-12 16:19:10Z thoar $
...
character(len=256), parameter :: source   = &
   "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/branches/rma_par_msg/utilities/error_handler_test.f90 $"
