...
%% -----------------------------------------------------------------------------
    ...
    function step_ahead(~, ~)
        ...
        if(handles.ready_to_advance)
            ...
            plot([handles.time_step - 1 + 0.1, handles.time_step + 0.1], ...
                [inf_prior, handles.inflation], 'Linestyle', '-.', 'Color', 'b');
            ...
            set(gca, 'XLim',[ens_axis(1) ens_axis(2)], 'YLim',[ens_axis(3) ens_axis(4)])
            ...
            % Turn off the negative labels
            set(gca, 'YTick', [0 0.1 0.2 0.3 0.4], 'XLim',[def_axis(1) def_axis(2)], 'YLim',[def_axis(3) def_axis(4)]);
            grid on;
...
%% -----------------------------------------------------------------------------
    ...
    function turn_on_controls ()
        ...
        %         set(handles.ui_edit_adap_inf_Std,               'Enable', 'On');
        %         set(handles.ui_text_adap_inf_Std,               'Enable', 'On');
        set(handles.ui_edit_adap_inf_Std_Min,           'Enable', 'On');
