...
integer, parameter, public :: &
  ...
  KIND_SEAICE_CONCENTR               = 318, &  ! for each category
  KIND_SEAICE_VOLUME                 = 319, &
  KIND_SEAICE_SNOWVOLUME             = 320

!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.

integer, parameter :: max_obs_generic = 320
...
obs_kind_names(312) = obs_kind_type(KIND_SEAICE_AGREG_THICKNESS,'KIND_SEAICE_AGREG_THICKNESS')
obs_kind_names(313) = obs_kind_type(KIND_SEAICE_AGREG_SNOWDEPTH,'KIND_SEAICE_AGREG_SNOWDEPTH')
obs_kind_names(314) = obs_kind_type(KIND_SEAICE_AGREG_VOLUME   ,'KIND_SEAICE_AGREG_VOLUME')
obs_kind_names(315) = obs_kind_type(KIND_SEAICE_AGREG_SNOWVOLUME,'KIND_SEAICE_AGREG_SNOWVOLUME')
...
obs_kind_names(318) = obs_kind_type(KIND_SEAICE_CONCENTR       ,'KIND_SEAICE_CONCENTR')
obs_kind_names(319) = obs_kind_type(KIND_SEAICE_VOLUME         ,'KIND_SEAICE_VOLUME')
obs_kind_names(320) = obs_kind_type(KIND_SEAICE_SNOWVOLUME     ,'KIND_SEAICE_SNOWVOLUME')
