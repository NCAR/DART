...
! MEXICO_AQS_PM25,         QTY_PM25
! END DART PREPROCESS KIND LIST

! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_MEXICO_AQS_PM25_mod, only : get_expected_mexico_aqs_pm25
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE

! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!   case(MEXICO_AQS_PM25)
!        call get_expected_mexico_aqs_pm25(state_handle, ens_size, location, obs_def%key, expected_obs, istatus) 
...
module obs_def_MEXICO_AQS_PM25_mod
   ...
   public :: get_expected_mexico_aqs_pm25

! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_MEXICO_AQS_PM25_mod.f90'
   ...
   namelist /obs_def_MEXICO_AQS_PM25_nml/ use_log_pm25
...
! Read the namelist entry.
   use_log_pm25=.false.
   call find_namelist_in_file("input.nml", "obs_def_MEXICO_AQS_PM25_nml", iunit)
   read(iunit, nml = obs_def_MEXICO_AQS_PM25_nml, iostat = rc)
   call check_namelist_read(iunit, rc, "obs_def_MEXICO_AQS_PM25_nml")

! Record the namelist values used for the run ... 
   if (do_nml_file()) write(nmlfileunit, nml=obs_def_MEXICO_AQS_PM25_nml)
   if (do_nml_term()) write(     *     , nml=obs_def_MEXICO_AQS_PM25_nml)
end subroutine initialize_module

!------------------------------------------------------------------------

subroutine get_expected_mexico_aqs_pm25(state_handle, ens_size, location, key, val, istatus)  
   ...
   logical                          :: return_now
   character(len=*), parameter      :: routine = 'get_expected_mexico_aqs_pm25'
!
...
end subroutine get_expected_mexico_aqs_pm25

!------------------------------------------------------------------------

end module obs_def_MEXICO_AQS_PM25_mod
