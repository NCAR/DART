...
! MOPITT_V8_CO_CPSR, QTY_CO
! END DART PREPROCESS TYPE DEFINITIONS
!
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!   use obs_def_mopitt_v8_co_cpsr_mod, only : get_expected_mopitt_v8_co_cpsr, &
!                                  read_mopitt_v8_co_cpsr, &
!                                  write_mopitt_v8_co_cpsr, &
!                                  interactive_mopitt_v8_co_cpsr
! END DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
!
! BEGIN DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!      case(MOPITT_V8_CO_CPSR)                                                           
!         call get_expected_mopitt_v8_co_cpsr(state_handle, ens_size, location, obs_def%key, obs_time, expected_obs, istatus)  
! END DART PREPROCESS GET_EXPECTED_OBS_FROM_DEF
!
! BEGIN DART PREPROCESS READ_OBS_DEF
!      case(MOPITT_V8_CO_CPSR)
!         call read_mopitt_v8_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS READ_OBS_DEF
!
! BEGIN DART PREPROCESS WRITE_OBS_DEF
!      case(MOPITT_V8_CO_CPSR)
!         call write_mopitt_v8_co_cpsr(obs_def%key, ifile, fileformat)
! END DART PREPROCESS WRITE_OBS_DEF
!
! BEGIN DART PREPROCESS INTERACTIVE_OBS_DEF
!      case(MOPITT_V8_CO_CPSR)
!         call interactive_mopitt_v8_co_cpsr(obs_def%key)
! END DART PREPROCESS INTERACTIVE_OBS_DEF
!
! BEGIN DART PREPROCESS MODULE CODE

module obs_def_mopitt_v8_co_cpsr_mod
...
! set_time sets time_type from julian day and seconds
   ...
   public :: write_mopitt_v8_co_cpsr, &
          read_mopitt_v8_co_cpsr, &
          interactive_mopitt_v8_co_cpsr, &
          get_expected_mopitt_v8_co_cpsr, &
          set_obs_def_mopitt_v8_co_cpsr
...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'obs_def_mopitt_v8_co_cpsr_mod.f90'
...
subroutine read_mopitt_v8_co_cpsr(key, ifile, fform)
...
! Need to know how many layers for this one
   ...
   if(counts1 > max_mopitt_co_obs) then
      write(string1, *) 'Not enough space for mopitt co cpsr obs.'
      write(string2, *) 'Can only have max_mopitt_co_obs (currently ',max_mopitt_co_obs,')'
      call error_handler(E_ERR,'read_mopitt_v8_co_cpsr',string1,source,text2=string2)
   endif
   
   call set_obs_def_mopitt_v8_co_cpsr(key, pressure_1, avg_kernel_1, prior_1, klay_1, nlayer_1, nlevel_1)
   
   deallocate(pressure_1, avg_kernel_1, prior_1)
   
end subroutine read_mopitt_v8_co_cpsr

!-------------------------------------------------------------------------------

subroutine write_mopitt_v8_co_cpsr(key, ifile, fform)
...
end subroutine write_mopitt_v8_co_cpsr

!-------------------------------------------------------------------------------

subroutine interactive_mopitt_v8_co_cpsr(key)
...
! STOP because routine is not finished.
   write(string1,*) 'interactive_mopitt_v8_co_cpsr not yet working.'
   call error_handler(E_ERR, 'interactive_mopitt_v8_co_cpsr', string1, source)
   
   if(num_mopitt_co_obs >= max_mopitt_co_obs) then
      write(string1, *) 'Not enough space for an mopitt co obs.'
      write(string2, *) 'Can only have max_mopitt_co_obs (currently ',max_mopitt_co_obs,')'
      call error_handler(E_ERR, 'interactive_mopitt_v8_co_cpsr', string1, &
...
! Otherwise, prompt for input for the three required beasts
   ...
   write(*, *) 'Creating an interactive_mopitt_v8_co_cpsr observation'
   write(*, *) 'This featue is not setup '

end subroutine interactive_mopitt_v8_co_cpsr

!-------------------------------------------------------------------------------

subroutine get_expected_mopitt_v8_co_cpsr(state_handle, ens_size, location, key, obs_time, expct_val, istatus)
   ...
   character(len=*), parameter :: routine = 'get_expected_mopitt_v8_co_cpsr'
...
! Convert from VMR to molar density (mol/m^3) (MOPITT retrieval profile is VMR ppbv)
         if(use_log_co) then
...
!   call exit_all()
!
! Convert expected observation from log10(ppbv) to ppbv (not needed for CPSR)
...
end subroutine get_expected_mopitt_v8_co_cpsr

!-------------------------------------------------------------------------------

subroutine set_obs_def_mopitt_v8_co_cpsr(key, co_pressure, co_avg_kernel, co_prior, &
co_klay, co_nlayer, co_nlevel)
   ...
   if(num_mopitt_co_obs >= max_mopitt_co_obs) then
      write(string1, *) 'Not enough space for mopitt co cpsr obs.'
      write(string2, *) 'Can only have max_mopitt_co_obs (currently ',max_mopitt_co_obs,')'
      call error_handler(E_ERR,'set_obs_def_mopitt_v8_co_cpsr',string1,source,revision, &
...
end subroutine set_obs_def_mopitt_v8_co_cpsr

end module obs_def_mopitt_v8_co_cpsr_mod
