...
<br>
<br>
DART makes a distinction between specific
<em class="unix">observation types</em> and generic
<em class="unix">observation quantities</em>.  The role of the various
obs_def input files is to define the mapping between the types and quantities,
...
<em class="unix">obs_type_files</em> variable.  This variable is a string
...
is the generic observation <em class="unix">quantity</em>.  The quantities
 available to DART are defined at compile time by <em>preprocess</em> via the
option 'quantity_files' in the <em>preprocess_nml</em> namelist.
...
with public routines then a "use" statement like:
<pre>
...
are available to be called.  This would look like:
<pre>
! BEGIN DART PREPROCESS USE OF SPECIAL OBS_DEF MODULE
! use obs_def_1d_state_mod, only : write_1d_integral, read_1d_integral, &amp;
!                                  interactive_1d_integral, get_expected_1d_integral
...
<TR><TD>&nbsp;</TD><TD><A HREF="#get_obs_def_type_of_obs">get_obs_def_type_of_obs</A></TD></TR>
...
<TR><TD>&nbsp;</TD><TD><A HREF="#set_obs_def_type_of_obs">set_obs_def_type_of_obs</A></TD></TR>
...
<TR><TD valign=top> kind                  </TD>
    <TD>Despite the name, the specific type of the observation.      </TD></TR>
...
<TR><TD valign=top> key                   </TD>
    <TD>Unique identifier for observations of a particular type.</TD></TR>
</TABLE>
...
<P>
Creates an obs_def type with location, type, time and error_variance
specified.
</P>
...
<TR><TD valign=top><em class=code>kind&nbsp;&nbsp;</em></TD>
    <TD>Observation type for obs_def</TD></TR>
...
<A NAME="get_obs_def_type_of_obs"></A>
<br>
<div class=routine>
<em class=call> var = get_obs_def_type_of_obs(obs_def) </em>
<pre>
integer                         :: <em class=code>get_obs_def_type_of_obs</em>
type(obs_def_type),  intent(in) :: <em class=code>obs_def</em>
</pre>
</div>
...
<TABLE width=100% border=0 summary="" cellpadding=3>
<TR><TD valign=top><em class=code>var&nbsp;&nbsp;</em></TD>
    <TD>Returns the observation type from an obs_def</TD></TR>
<TR><TD valign=top><em class=code>obs_def&nbsp;&nbsp;</em></TD>
    <TD>An obs_def</TD></TR>
</TABLE>
...
<br>
<div class=routine>
<em class=call> obs_name = get_name_for_type_of_obs(obs_kind_ind) </em>
<pre>
...
<TABLE width=100% border=0 summary="" cellpadding=3>
<TR><TD valign=top><em class=code>var&nbsp;&nbsp;</em></TD>
    <TD>Returns name from an observation type</TD></TR>
<TR><TD valign=top><em class=code>obs_kind_ind&nbsp;&nbsp;</em></TD>
    <TD>An observation type</TD></TR>
</TABLE>
...
<A NAME="set_obs_def_type_of_obs"></A>
<br>
<div class=routine>
<em class=call> call set_obs_def_type_of_obs(obs_def, kind) </em>
<pre>
type(obs_def_type), intent(inout) :: <em class=code>obs_def</em>
integer,            intent(in)    :: <em class=code>kind</em>
</pre>
...
<TR><TD valign=top><em class=code>obs_def&nbsp;&nbsp;</em></TD>
    <TD>An obs_def</TD></TR>
<TR><TD valign=top><em class=code>kind&nbsp;&nbsp;</em></TD>
    <TD>An integer observation type</TD></TR>
</TABLE>
...
<TR><!-- routine --><TD VALIGN=top>get_expected_obs_from_def</TD>
    <!-- message --><TD VALIGN=top>Attempt to evaluate undefined observation type</TD>
    <!-- comment --><TD VALIGN=top>An observation type for which
...
<TR><!-- routine --><TD VALIGN=top>read_obs_def</TD>
    ...
    <!-- comment --><TD VALIGN=top>Reading for an observation type for which
     no forward operator has been defined is an error.</TD>
</TR>

<TR><!-- routine --><TD VALIGN=top>write_obs_def</TD>
    <!-- message --><TD VALIGN=top>Attempt to write for undefined obs_kind index</TD>
    <!-- comment --><TD VALIGN=top>Writing for an observation type for which
     no forward operator has been defined is an error.</TD>
</TR>
...
<TR><!-- routine --><TD VALIGN=top>interactive_obs_def</TD>
    ...
    <!-- comment --><TD VALIGN=top>Creating an observation type for which
     no forward operator has been defined is an error.</TD>
</TR>
