...
<H4>trial COSMOS Text File to DART Converter</H4>
...
The <b>Level 2 Data</b> is most suited for use with DART, but does not currently
have a correction for the amount of hydrogen in the atmospheric volume near the probe.
...
<li>acquire the development observation data and prefix the filename with the station name (or else they
    all get named <em class=file>corcounts.txt</em>)
    and enter the filename into <em class=input>&amp;COSMOS_development_nml</em></li>
...
<li>run <em class=program>COSMOS_development</em> to generate a DART observation sequence 
...
<H2>PROGRAMS</H2>
<P>
The <em class=file>COSMOS_development.f90</em> file is the source code
...
<em class=program>COSMOS_development</em>
...
<a href="../../forward_operators/obs_def_land_mod.f90">observations/forward_operators/obs_def_land_mod.f90</a> and
<a href="../../forward_operators/obs_def_COSMOS_mod.f90">observations/forward_operators/obs_def_COSMOS_mod.f90</a>.
...
<br />
<br />
<em class=program>COSMOS_development</em> reads the site name from
