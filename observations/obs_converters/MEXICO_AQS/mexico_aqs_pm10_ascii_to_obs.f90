...
program mexico_aqs_pm10_ascii_to_obs
...
!
      use time_manager_mod, only :    set_date,                  &
                                      ...
                                      get_time
!
      use obs_kind_mod, only :        MEXICO_AQS_PM10,                 &
...
! version controlled file description for error handling, do not edit
      character(len=*), parameter :: source   = 'mexico_aqs_pm10_ascii_to_obs.f90'
...
!-----------------------------------------------------------------------------
   ...
   end program mexico_aqs_pm10_ascii_to_obs
!
