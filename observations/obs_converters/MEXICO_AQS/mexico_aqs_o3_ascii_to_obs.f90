...
program mexico_aqs_o3_ascii_to_obs
...
!
      use time_manager_mod, only :    set_date,                  &
                                      ...
                                      get_time
!
      use obs_kind_mod, only :        MEXICO_AQS_O3,                 &
...
! version controlled file description for error handling, do not edit
      character(len=*), parameter :: source   = 'mexico_aqs_o3_ascii_to_obs.f90'
...
!-----------------------------------------------------------------------------
   ...
   end program mexico_aqs_o3_ascii_to_obs
!
