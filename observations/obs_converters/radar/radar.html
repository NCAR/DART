...
exist, and will be placed in this directory when they are ready for
distribution.  Observations generated by these programs have been
successfully assimilated with weather models in the DART framework.  
</P>

<P>
This directory currently contains a program for generating
synthetic radar observations for a 
<a href="http://en.wikipedia.org/wiki/WSR-88D">WSR-88D (NEXRAD)</a>.  
It can generate reflectivity and/or doppler radial velocity
observations with clear-air or storm sweep patterns, for testing 
or for OSSEs (Observing System Simulation Experiments).
</P>

<P>
There are challenges to working with
radar data; for more information contact us.
</P>
