...
#
# This script merges a set of input obs files into 1-hour files.  
...
# starting at 05:30:01Z and ending at 06:30:00Z.  Note that a file
# with a name ending in YYYY-MM-DD-00000 contains data from
# 23:30:01Z the previous day to 00:30:00Z of the day YYYY-MM-DD.
#
...
# updated to run multiple merge jobs at once.  (if it hasn't been
# moved or renamed, see multi_parallel.batch in this same dir for
# how to invoke multiple parallel merge jobs in a single script.)
#
...
# if start_hour is 12Z and step is 1H, then the first file will be centered 
# at 12Z on this day, with data starting at 11.5Z and ending at 12.5Z.
#
...
#  echo /glade/p/cisl/dares/Observations/AIRS/AIRS_24_sub9x10_nceperrs/${ym}/obs_seq.AIRS.${ymd}.out >> olist
  ...
  outdir=/glade/../where_you_want/${ym}_1H_CESM
  ...
  #  change "doit" to "" to debug; 
  #  change "" to "doit" to make files
  if [ "" ] ; then
