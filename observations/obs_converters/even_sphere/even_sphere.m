...
% This creates input to create_obs_sequence,
%      which creates a set_def.out for use in create_fixed_network_seq.
%      See the README.
...
% the surface [1000 925 850 700 500 400 300 250 200 150 100 70 50 10] mb.
%
...
T_variance = [1.44  1.0  0.64 0.64 0.64 0.64 0.81 1.44  1.44 1.0  0.64 0.64 0.81 1.0]
W_variance = [1.96  2.25 2.25 2.56 4.41 6.76 9.0  10.24 7.29 5.76 4.41 4.41 4.41 4.41]
...
% Plot an approximate CAM grid for comparison
