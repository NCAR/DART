...
# for t in range(0,1):
  ...
  if os.path.exists('obs_seq.'+str(curr_date)[0:4]+'-'+str(curr_date)[4:6]+'-'+str(curr_date)[6:]+'-00000'):
    ...
    os.system(comd)
    comd = 'mv obs_seq.'+str(curr_date)[0:4]+'-'+str(curr_date)[4:6]+'-'+str(curr_date)[6:]+'-00000 ./OBS/multivariate/mem_00'+str(ens_truth)+'/stdx2/'
    os.system(comd)
