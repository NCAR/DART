...
character(len=*), parameter :: routine = 'seaice_fy_to_obs_netcdf'
...
alongloop:  do j = 1, aydim
   acrossloop: do i = 1, axdim
      ...
      !>@todo  maybe    thiserr = max(seaice_fy(i,j)*terr, 0.01_r8)  (or some other min error)
...
deallocate(seaice_fy, lon, lat, qc_array, tmask)
