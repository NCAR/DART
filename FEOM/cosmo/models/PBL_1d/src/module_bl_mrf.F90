...
!mp@
            hflux(kk)=g/cp-hgamt(i)/pbl(i)
            qflux(kk)=-hgamq(i)/pbl(i)
...
!mp@
          rdz=1./dza(i,MAX(k-1,1))
          ktmp=MIN(kte,kk+1)
          hflux(kk)=-xkzh(i,k)*&
               &((a1(i,ktmp)-a1(i,kk))*rdz+hflux(kk))
          qflux(kk)=-xkzh(i,k)*&
               &((a2(i,ktmp)-a2(i,kk))*rdz+qflux(kk))
          k_t(kk)=xkzh(i,k)
          k_m(kk)=xkzm(i,k)
...
!mp@
          ...
          ktmp=MIN(kte,kk+1)
          uflux(kk)=-xkzm(i,k)*&
               &((a1(i,ktmp)-a1(i,kk))*rdz)
          vflux(kk)=-xkzm(i,k)*&
               &((a2(i,ktmp)-a2(i,kk))*rdz)
