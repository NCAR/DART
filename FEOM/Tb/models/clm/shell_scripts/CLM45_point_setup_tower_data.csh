...
# =============================================================================
#
setenv refcase     ${neon_site}_annual_freerun_ICLM45BGC_point
setenv refyear     2008
setenv refmon      12
setenv refday      31
setenv reftod      00000
...
# setenv stagedir /glade/scratch/afox/archive/NMPJ_annual_assim_ICLM45BGC_point/rest/2012-11-20-00000
...
if (    -d     ${cesmroot}/SourceMods ) then
   ${COPY} -r  ${cesmroot}/SourceMods/* ${caseroot}/SourceMods/
else
...
#   echo "hist_fincl1 = 'NEP',"                        >> ${fname}
   echo "hist_fincl2 = 'NEP','FSH','EFLX_LH_TOT_R','GPP','ER','SR','NPP'"  >> ${fname}
   echo "hist_nhtfrq = -24,-8640"                   >> ${fname}
   echo "hist_mfilt  = 360,1"                  >> ${fname}
...
#      sed s/NINST/$instance/g ${FNAME2}_$instance >! out.$$
      sed s/NINST/tower/g ${FNAME2}_$instance >! out.$$
