...
\rm -f preprocess *.o *.mod input.nml*_default
...
foreach TARGET ( mkmf_* )
   ...
   case mkmf_preprocess:
      breaksw
   case mkmf_dart_to_nogaps:
      breaksw
   case mkmf_nogaps_to_dart:
      breaksw
   default:
      @ n = $n + 1
      echo
...
foreach PROG ( filter wakeup_filter dart_to_nogaps nogaps_to_dart )
