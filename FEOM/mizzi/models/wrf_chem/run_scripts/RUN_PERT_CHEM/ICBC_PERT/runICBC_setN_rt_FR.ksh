...
#   export WRFBDY=wrfbdy_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e${IENS}
   echo 'get inp'
   cp ${IC_METDIR}/${WRFINP} ./.
#   cp ${BC_METDIR}/${WRFBDY} ./.
   ls set${i}
...
#   ./run_mozbc_rt_FR.csh type=bc mozbc_inp=mozbc.bc.inp.set${i} ens=${IENS}
   echo 'put files'
   echo 'OK'
done
#################parent files################
...
export CHEMDIR=${RUN_DIR}/${YEAR}${MONTH}${DAY}${HOUR}/wrfchem_chem_icbc
export WRFINP=wrfinput_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00
#export WRFBDY=wrfbdy_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00
cp ${METDIR}/${WRFINP} ./.
#cp ${METDIR}/${WRFBDY} ./.
mv ${WRFINP} wrfinput_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000
#mv ${WRFBDY} wrfbdy_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000
...
mv wrfinput_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000 ${WRFINP}
#mv wrfbdy_d02_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000 ${WRFBDY}
################parent files#################
