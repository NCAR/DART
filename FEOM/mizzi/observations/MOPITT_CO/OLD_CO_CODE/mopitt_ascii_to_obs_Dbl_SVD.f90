...
! Rotate terms in the forward operator       
          call mat_prd(UT_cvr,avg_k,s_avg_k,nlvls,nlvls,nlvls,nlvls)
          call mat_tri_prd(UT_cvr,cov_r,U_cvr,s_cov_r,nlvls,nlvls,nlvls,nlvls,nlvls,nlvls)
          call lh_mat_vec_prd(UT_cvr,x_r,s_x_r,nlvls)
          call lh_mat_vec_prd(UT_cvr,x_p,s_x_p,nlvls)
!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! Now rotate the rotated forward operator with 
! the SVD of s_avg_k
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
...
! Rotate remaining terms in the forward operator
          allocate(rs_cov_r(nlvls,nlvls),rs_x_r(nlvls),rs_x_p(nlvls))    
