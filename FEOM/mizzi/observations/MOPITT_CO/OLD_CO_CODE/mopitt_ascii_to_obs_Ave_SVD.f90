...
! Read MOPITT
! APM: the w/date inter-ascii file format is not ready yet
!  read(fileid,*,iostat=ios) transform_typ, apm_days, apm_secs, lat, lon, nlevels, dofs 
  read(fileid,*,iostat=ios) transform_typ, sec, lat, lon, nlevels, dofs 
!  print *, 'trans_typ, days, secs, lat, lon, nlevels, dofs ',trim(transform_typ),days,secs,lat,lon,nlevels,dofs
  nlvls=int(nlevels)
...
! APM: the w/date inter-ascii file is not yet ready
!       read(fileid,*,iostat=ios) transform_typ, apm_days, apm_secs, lat, lon, nlevels, dofs 
       read(fileid,*,iostat=ios) transform_typ, sec, lat, lon, nlevels, dofs 
       nlvls=int(nlevels)
...
! Read MOPITT
! APM: the w/date inter-ascii file format is not yet ready
!    read(fileid,*,iostat=ios) transform_typ, apm_days, apm_secs, lat, lon, nlevels, dofs 
    read(fileid,*,iostat=ios) transform_typ, sec, lat, lon, nlevels, dofs 
    nlvls=int(nlevels)
! Error Check
