...
obs_kind_names(145) = obs_kind_type(KIND_AIR_TEMPERATURE,   'KIND_AIR_TEMPERATURE')
obs_kind_names(145) = obs_kind_type(KIND_WATER_TEMPERATURE, 'KIND_WATER_TEMPERATURE')
