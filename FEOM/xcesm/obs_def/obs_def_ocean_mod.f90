...
!WATER_TEMPERATURE,             KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!ARGO_TEMPERATURE,              KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!ADCP_TEMPERATURE,              KIND_WATER_TEMPERATURE,     COMMON_CODE
!FLOAT_SALINITY,                KIND_SALINITY,              COMMON_CODE
!FLOAT_TEMPERATURE,             KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!DRIFTER_TEMPERATURE,           KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!GLIDER_TEMPERATURE,            KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!MOORING_TEMPERATURE,           KIND_WATER_TEMPERATURE,     COMMON_CODE
!MOORING_PRESSURE,              KIND_PRESSURE,              COMMON_CODE
!BOTTLE_SALINITY,               KIND_SALINITY,              COMMON_CODE
!BOTTLE_TEMPERATURE,            KIND_WATER_TEMPERATURE,     COMMON_CODE
!CTD_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!CTD_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
!TCTD_SALINITY,                 KIND_SALINITY,              COMMON_CODE
!TCTD_TEMPERATURE,              KIND_WATER_TEMPERATURE,     COMMON_CODE
!STD_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!STD_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
!XCTD_SALINITY,                 KIND_SALINITY,              COMMON_CODE
!XCTD_TEMPERATURE,              KIND_WATER_TEMPERATURE,     COMMON_CODE
!MBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!MBT_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
!XBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!XBT_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
!DBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!DBT_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
!APB_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!APB_TEMPERATURE,               KIND_WATER_TEMPERATURE,     COMMON_CODE
...
!SATELLITE_MICROWAVE_SST,       KIND_WATER_TEMPERATURE,     COMMON_CODE
!SATELLITE_INFRARED_SST,        KIND_WATER_TEMPERATURE,     COMMON_CODE
