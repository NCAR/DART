...
use             model_mod, only : static_init_model, get_model_size, get_state_meta_data_distrib, &
...
write(*,*) ' Testing get_state_meta_data_distrib           '
write(*,*) '-----------------------------------------------'
...
write(*,*) ' Testing model_interpolate_distrib             '
write(*,*) '-----------------------------------------------'
write(*,*)
...
call model_interpolate_distrib(ens_handle, loc, mykindindex, ios_out, interp_vals)
...
call get_state_meta_data_distrib(ens_handle, iloc, loc, var_type)
...
do ilon = 1, nlon
   ...
   do jlat = 1, nlat
      ...
      do kvert = 1, nvert
         ...
         call model_interpolate_distrib(ens_handle, loc, mykindindex, ios_out, field(ilon,jlat,kvert,:))
call model_interpolate_distrib(ens_handle, loc, mykindindex, ios_out, interp_vals)
