...
!
! $Id: null_win_mod.f90 8571 2015-09-12 19:54:08Z hkershaw $
...
character(len=256), parameter :: source   = &
   "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/branches/rma_trunk_mpi_get_in_utils/distributed/null_win_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 8571 $"
character(len=128), parameter :: revdate  = "$Date: 2015-09-12 13:54:08 -0600 (Sat, 12 Sep 2015) $"
