function [dimlen, dimid] = nc_dim_exists(fname,dimname)
%% nc_dim_exists Tests to see if the variable exists in a netCDF file - without throwing an error.
...
% dimlen = nc_dim_exists(fname,dimname)
%
