...
# set destin = '/ncar/dart/raeder/I'

# tar cf reloc.tar trans_time
# *[^od] filter assim_region 

# cp -p filter  $destin
# cp -p assim_region  $destin
# cp -p trans_time  $destin
# cp -p trans_pv_sv  $destin
# cp -p trans_sv_pv  $destin
# cp perfect_model_obs $destin
# cp -p trans_pv_sv_time0  $destin
# cp -p create_obs_sequence  $destin
# cp -p create_fixed_network_seq  $destin
