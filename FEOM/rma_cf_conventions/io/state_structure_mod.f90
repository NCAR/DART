...
use utilities_mod, only : E_ERR, E_MSG, error_handler, nc_check, do_output, &
                          to_upper
use  obs_kind_mod, only : paramname_length, get_raw_obs_kind_name, &
                          get_raw_obs_kind_index
use     types_mod, only : r8, r4, i8, MISSING_R8, MISSING_R4, MISSING_I
...
integer,  intent(in)  :: dom_id
integer,  intent(in)  :: var_id
real(r8), intent(out) :: missing_value_r8
