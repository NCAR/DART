...
type(time_type)         :: ob_time, init_time, this_time, period, last_time
integer                 :: seconds, days, i, j, num_obs, option, num_times, num_copies, num_qc
...
20 write(*, *) 'Input the spread in time in seconds'
