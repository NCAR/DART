...
write(obs_kind_out_unit, 51) '! AUTOGENERATED Integer definitions for DART KINDS'
...
! Write out the max_obs_generic (kinds)
! FIXME:  this should be max_obs_kinds, but the other name is public
! and refers to types.  sigh.
write(obs_kind_out_unit, 51) blank_line
...
! Write out the max_obs_specific (types)
! FIXME:  this should be max_obs_types, but max_obs_kinds is already a
! public and means types.
write(obs_kind_out_unit, 51) blank_line
...
! For backwards compatibility, write this out even though the name is
! completely wrong (this is specific types).   sigh.
write(obs_kind_out_unit, 51) blank_line
write(obs_kind_out_unit, 51) '! Backwards compatibility for public constant: Integer number of DART TYPES'
