...
indexed by index_in, in the model 
state vector. The location defines where the state variable is located. 
For 9-variable, the three X variables are at 0, 1/9, and 2/9, 
the three Y variables
at 3/9, 4/9 and 5/9, and the three z variables at 6/9, 7/9, and 8/9
on a cyclic [0, 1] domain. The variable type is always returned as 1.
</P>
...
i/9, i = 0, 1, ...,8, in the cyclic [0, 1] domain. So, a value of 1/18 is an
average of the X1 and X2 variables. The type variable is not used here
...
<TR><TD>g </TD>
    <TD>real(r8) </TD>
    <TD>Model parameter, see comp_dt in code for equations.
</TD></TR>

<TR><TD>delta_t </TD>
    <TD>real(r8) </TD>
    <TD>Non-dimensional timestep.  This is mapped to the dimensional timestep
specified by time_step_days and time_step_seconds.
</TD></TR>
