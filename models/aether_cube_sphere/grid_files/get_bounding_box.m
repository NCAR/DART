...
function [grid_face, grid_lat_ind, grid_lon_ind, grid_pt_lat, grid_pt_lon, corner_detected] = ...
...
for i = 1:4
   [grid_face(i), grid_lat_ind(i), grid_lon_ind(i), corner_detected] = fix_face(face, lat_grid(i), lon_grid(i), np);
   if(corner_detected)
      corner_index = i;
      break
   end
