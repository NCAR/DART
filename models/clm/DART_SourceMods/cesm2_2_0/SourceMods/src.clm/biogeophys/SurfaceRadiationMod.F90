...
! /glade/work/thoar/CESM/my_cesm_sandbox/components/clm/src/biogeophys/SurfaceRadiationMod.F90
!
! This sourcemod allows the 'PARVEG' variable to be added to the
! history file.  'PARVEG' is the 'absorbed par by vegetation', as opposed to
! 'PARVEGLN', which is the 'absorbed par by vegetation at local noon'
...
module SurfaceRadiationMod
  ...
  type, public :: surfrad_type
     ...
     real(r8), pointer, private  :: parveg_patch          (:) ! patch  absorbed par by vegetation (W/m**2)
...
contains
  ...
  subroutine InitAllocate(this, bounds)
    ...
    allocate(this%parveg_patch          (begp:endp))              ; this%parveg_patch          (:)   = nan
  ...
  subroutine SurfaceRadiation(bounds, num_nourbanp, filter_nourbanp, &
     ...
     associate(                                                     &
          ...
          parveg          =>    surfrad_inst%parveg_patch         , & ! Output: [real(r8) (:)   ] absorbed par by vegetation (W/m**2)
