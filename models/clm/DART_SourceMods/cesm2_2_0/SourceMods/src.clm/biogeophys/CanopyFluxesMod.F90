...
! /glade/work/thoar/CESM/my_cesm_sandbox/components/clm/src/biogeophys/CanopyFluxesMod.F90
!
! This sourcemod is required for the SIF forward operator.
! The PhotosyntesisMod.F90 also needs changes to support the SIF forward operator.
         ...
         if ( use_fates ) then      
            ...
            if ( use_hydrstress ) then
               call PhotosynthesisHydraulicStress (bounds, fn, filterp, &
                    ...
                    froot_carbon(begp:endp), croot_carbon(begp:endp)) ! MS added downreg
            else
