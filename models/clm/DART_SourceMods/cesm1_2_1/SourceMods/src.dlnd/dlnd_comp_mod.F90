...
! /glade/p/cesm/cseg/collections/cesm1_2_1/models/lnd/dlnd/dlnd_comp_mod.F90
...
!-------------------------------------------------------------------------------
   ...
   &                          scmlat=scmlat, scmlon=scmLon)
    ...
    ! Read restart
    !----------------------------------------------------------------------------
    !*****POPDART Sept 27,2012 AliciaK
    !*****hardcode read_restart so that dlnd does not look for rpointers
    !**** or restart files

    write(6,*) "Setting read_restart to .false. in DLND" !ALICIAK
    read_restart = .false. 
