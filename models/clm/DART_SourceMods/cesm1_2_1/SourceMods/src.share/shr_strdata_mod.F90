...
! DART bugzilla 1927 fix for 'longwave radiation error'
! DART note: this file started life as:
! /glade/p/cesmdata/cseg/collections/cesm1_2_1/models/csm_share/shr/shr_strdata_mod.F90
     ...
     if (trim(SDAT%tintalgo(n)) == 'coszen') then
        ...
        do i = 1,lsizeF
           if (cosz(i) > solZenMin) then
              ...
              ! The creation of some DATMS can result in slightly negative fluxes.
              ! prevent against negative solar fluxes ... temporary measure
              ! This is reported in bugzilla 1927
