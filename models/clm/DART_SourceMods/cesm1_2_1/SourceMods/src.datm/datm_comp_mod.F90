...
! /glade/p/cesm/cseg/collections/cesm1_2_1/models/atm/datm/datm_comp_mod.F90
...
!-------------------------------------------------------------------------------
 ...
 if (phase == 1) then
   ...
   &                          scmlat=scmlat, scmlon=scmLon)
    ...
    ! TJH  this prevents the need to have a COUPLER restart file.
    ! TJH  From an email to Bill Sacks from Tony Craig dated 2011/8/12
    ! TJH  one line change to models/atm/datm/datm_comp_mod.F90
