...
! /glade/p/cesmdata/cseg/collections/cesm1_2_1/models/atm/cam/src/dynamics/fv/cd_core.F90
...
! Local scalars
      ...
      real(r8), parameter ::  D64_0                   =  64.0_r8
...
! D-grid
        ...
        do k=kfirst,klast
          ...
          if (ldiv2) then
            ...
            ! DART this change is specific for WACCM. This entire file
            ! (cd_core.F90) is not used in the SourceMods when not using WACCM.
            ! The DART/CESM setup scripts remove this file when not using WACCM.
            ! That ensures the use of the default CESM values.
            tau = max(D1_0, tau) / (D64_0*abs(dt))
