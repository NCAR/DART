...
! /glade/p/cesm/releases/cesm1_2_1/models/lnd/clm/src/clm4_5/biogeophys/SLakeHydrologyMod.F90
!
! NOTE: It includes a Lake Hydrology bug documented in bugzilla report 1717
! and may resolve bugzilla report 1927.
...
!!!!!!!!!!
    ...
    do fp = 1, num_lakep
       ...
       ! TJH this block is to correct for bugzilla 1927 ... ultimately bugzilla 1717
       ! http://bugs.cgd.ucar.edu/show_bug.cgi?id=1927
       ...
       if (unfrozen(c)) then
          ...
          if (heatrem + denh2o*dz_lake(c,1)*hfus > 0._r8) then            
             ...
             if (heatrem > 0._r8) then ! simply subtract the heat from the layer
                t_lake(c,1) = tfrz + heatrem/(cpliq*denh2o*dz_lake(c,1)) ! TJH as per Zack/Keith O.
