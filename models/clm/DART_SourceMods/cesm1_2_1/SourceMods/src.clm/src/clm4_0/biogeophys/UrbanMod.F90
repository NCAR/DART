...
! /glade/p/cesm/releases/cesm1_2_1/models/lnd/clm/src/clm4_0/biogeophys/UrbanMod.F90
...
!-----------------------------------------------------------------------
    ...
    do fl = 1,num_urbanl
       ...
       if (iter >= n) then
          ...
          write (iulog,*) 'crit is ',crit,' should be < 0.001'
          write (iulog,*) 'road_a(fl) is ',road_a(fl)
          write (iulog,*) 'sunwall_a(fl) is ',sunwall_a(fl)
          write (iulog,*) 'shadewall_a(fl) is ',shadewall_a(fl)
          write (iulog,*) 'lwtot(fl) is ',lwtot(fl)
          write (iulog,*) 'clm model is stopping'
          call endrun
       endif
