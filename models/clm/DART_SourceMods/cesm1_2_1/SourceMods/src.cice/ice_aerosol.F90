...
! /glade/p/cesm/cseg/collections/cesm1_2_1/models/ice/cice/src/source/ice_aerosol.F90
...
!AK            write(nu_diag,*) 'aerosol tracer:      ',k
!AK            write(nu_diag,*) 'aerotot-aerotot0     ',aerotot(ij,k)-aerotot0(ij,k) 
!AK            write(nu_diag,*) 'faero-fsoot          ',faero(i,j,k)*aicen(i,j)*dt &
!AK                                                   -(fsoot(i,j,k)-fsoot_old(i,j,k))*dt
          endif
         enddo
      enddo
      ...
      do ij = 1, icells
       ...
       .or. trcrn(i,j,nt_aero+2) < -puny .or. trcrn(i,j,nt_aero+3) < -puny) then
             ...
             write(nu_diag,*) 'MH INT neg in aerosol my_task = ',&
                                 ...
                                 ,' printing point = ',n &
                                 ,' i and j = ',i,j
!AK           write(nu_diag,*) 'MH Int Neg aero snowssl= ',aerosno0(i,j,1,1)
!AK           write(nu_diag,*) 'MH Int Neg aero new snowssl= ',aerosno(i,j,1,1)
!AK           write(nu_diag,*) 'MH Int Neg aero snowint= ',aerosno0(i,j,1,2)
!AK           write(nu_diag,*) 'MH Int Neg aero new snowint= ',aerosno(i,j,1,2)
!AK           write(nu_diag,*) 'MH Int Neg aero ice_ssl= ',aeroice0(i,j,1,1)
!AK           write(nu_diag,*) 'MH Int Neg aero new ice_ssl= ',aeroice(i,j,1,1)
!AK           write(nu_diag,*) 'MH Int Neg aero ice_int= ',aeroice0(i,j,1,2)
!AK           write(nu_diag,*) 'MH Int Neg aero new ice_int= ',aeroice(i,j,1,2)
!AK           write(nu_diag,*) 'MH Int Neg aero aicen= ',aicen(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero vicen= ',vicen(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero vsnon= ',vsnon(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero viceold= ',vice_old(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero vsnoold= ',vsno_old(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero melts= ',melts(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero meltt= ',meltt(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero meltb= ',meltb(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero congel= ',congel(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero snoice= ',snoice(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero evap sno?= ',dhs_evap(ij)
!AK           write(nu_diag,*) 'MH Int Neg aero evap ice?= ',dhi_evap(ij)
!AK           write(nu_diag,*) 'MH Int Neg aero fsnow= ',fsnow(i,j)
!AK           write(nu_diag,*) 'MH Int Neg aero faero= ',faero(i,j,1)
!AK           write(nu_diag,*) 'MH Int Neg aero fsoot= ',fsoot(i,j,1)
           end if !
