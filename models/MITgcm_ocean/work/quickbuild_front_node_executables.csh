...
#Thu Nov 12 13:27:21 AST 2015
# cray-netcdf/4.3.2                                    2015/02/23 22:12:32
# cray-netcdf/4.3.3.1                      default     2015/10/28  7:09:24
# cray-netcdf-hdf5parallel/4.3.2                       2015/02/23 22:12:32
# cray-netcdf-hdf5parallel/4.3.3.1         default     2015/10/28  7:09:24
# cray-parallel-netcdf/1.5.0                           2015/02/23 22:16:09
# cray-parallel-netcdf/1.6.0                           2015/04/13  8:53:33
# cray-parallel-netcdf/1.6.1               default     2015/10/28  7:09:46
...
#mpirun -np 1 ./preprocess || exit 99
./preprocess || exit 99
...
# foreach TARGET ( mkmf_trans_* )
#foreach TARGET ( mkmf_obs_sequence_tool mkmf_trans_* )
#   foreach TARGET ( mkmf_restart_file_tool )
# foreach TARGET ( mkmf_create_ocean_obs )
#foreach TARGET ( mkmf_filter )
#foreach TARGET ( mkmf_filter mkmf_wakeup_filter )
#foreach TARGET ( mkmf_obs_diag )
#foreach TARGET ( mkmf_obs_sequence_tool )
#foreach TARGET ( mkmf_perfect_model_obs )

#foreach TARGET ( mkmf_obs_sequence_tool mkmf_restart_file_tool mkmf_obs_diag mkmf_create_ocean_obs mkmf_trans_* )
#foreach TARGET ( mkmf_obs_sequence_tool mkmf_restart_file_tool mkmf_obs_diag mkmf_create_ocean_obs )
#foreach TARGET ( mkmf_create_ocean_obs mkmf_obs_sequence_tool mkmf_restart_file_tool mkmf_obs_diag )

foreach TARGET ( mkmf_obs_sequence_tool mkmf_obs_diag mkmf_create_ocean_obs mkmf_trans_mitdart )
...
# $URL: https://proxy.subversion.ucar.edu/DAReS/DART/trunk/models/MITgcm_ocean/work/quickbuild.csh $
# $Revision: 4945 $
# $Date: 2011-06-03 01:29:30 +0300 (Fri, 03 Jun 2011) $
