...
parser = argparse.ArgumentParser(
    description='Get the time of a the Ensemble simulation'
)
...
#assim_window_sec = timedelta(seconds=(60*60)*assim_window_hr)

#start_window = valid_time  + timedelta(seconds=1)
#end_window = valid_time + assim_window_sec
