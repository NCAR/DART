...
from pwsdart.core.setup_experiment_tools import establish_config
...
def create_usgs_daily_obs_seq(config):
    ...
    link_files_list = [input_nml_file, gages_list_file]

    print("arezoo : I am here")
    # Identify obs or not...
    if daily_dict['identity_obs']:

        converter = dart_compile.models__pywatershed__work.exes['create_identity_streamflow_obs'].name
        ...
        link_files_list = link_files_list + [converter, hydro_rst_file, route_link_f]
...
if __name__ == "__main__":
    ...
    the_desc = "Convert pywatershed-DART observations in parallel."
    the_epilog = """
    Additional Examples:
