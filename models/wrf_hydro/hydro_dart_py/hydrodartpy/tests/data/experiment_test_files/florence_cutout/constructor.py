...
# Also might as well remove nudging from the domain
...
values = '/glade/work/jamesmcc/domains/private/florence_933020089/NWM/RESTART_open-loop/HYDRO_RST.2018-08-15_00:00_DOMAIN1'
wrf_hydro_ens_sim.set_member_diffs(att_tuple, values)
