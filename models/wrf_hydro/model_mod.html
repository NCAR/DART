...
<HTML>
<HEAD>
<TITLE>module model_mod (WRF-Hydro)</TITLE>
...
<H1>MODULE model_mod (WRF-Hydro)</H1>
...
The gridded version of the model has bits/bobs in:
...
Only the gridcells with flow are retained in the qlink[1,2],hlink variables - 
so they must be unpacked in EXACTLY the same way as wrfHydo packs them from the grid to their 'sparse' representation.
