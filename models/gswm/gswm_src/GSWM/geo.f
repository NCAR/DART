...
C Format Hough Decomposition output
  ...
  500   FORMAT(1X,5HGP11=,e10.3,1H/,F4.1,1X,5HGP12=,e10.3,1H/,F4.1,1X,
     +    5HGP13=,e10.3,1H/,F4.1,1X,6HGP1M2=,e10.3,1H/,F4.1,1X,
     +    6HGP1M4=,e10.3,1H/,F4.1,1X,6HGP1M1=,e10.3,1H/,F4.1)
  600   FORMAT(1X,5HGP22=,e10.3,1H/,F4.1,1X,5HGP23=,e10.3,1H/,F4.1,1X,
     +    5HGP24=,e10.3,1H/,F4.1,1X,5HGP25=,e10.3,1H/,F4.1,1X,5HGP26=,
     +    e10.3,1H/,F4.1)
  700    FORMAT(1X,4HT33=,e10.3,1H/,F4.1,1X,4HT34=,e10.3,1H/,F4.1,1X,
     +    4HT35=,e10.3,1H/,F4.1,1X,4HT36=,e10.3,1H/,F4.1)
...
200     FORMAT(1X,4HLAT=,F5.1,2X,6HGeoHt=,e10.3,1H/,F4.1,
     +		2X,4HGPS=,e10.3,1H/,F4.1)
201     FORMAT(1X,4HLAT=,F5.1,2X,4HGeo=,e10.3,1H/,F4.1,1x,
     +          4HRho=,e10.3,1H/,F4.1,1x,2HP=,e10.3,1H/,F4.1)
203     FORMAT(1X,4HLAT=,F5.1,2X,6HGeoHt=,e10.3,1H/,F4.1,1x,
     +          4HGPS=,e10.3,1H/,F4.1,1x,4HRho=,e10.3,1H/,F4.1,
     +          1x,2HP=,e10.3,1H/,F4.1)
...
C Both analyses must interpolate data fields
     ...
     +		vxym1,vxy1n,vxymn,255,vgtr,temp(1),sigma,ierr)
      call surf1(ij,nhts,clatt,xg,wgr,ij,wx1,wxm,wy1,wyn,wxy11,
     +		wxym1,wxy1n,wxymn,255,wgtr,temp(1),sigma,ierr)
      call surf1(ij,nhts,clatt,xg,vgi,ij,vx1,vxm,vy1,vyn,vxy11,
     +		vxym1,vxy1n,vxymn,255,vgti,temp(1),sigma,ierr)
      call surf1(ij,nhts,clatt,xg,wgi,ij,wx1,wxm,wy1,wyn,wxy11,
     +		wxym1,wxy1n,wxymn,255,wgti,temp(1),sigma,ierr)
