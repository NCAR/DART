...
c
      if(ibr.eq.1.and.mois.ne.1)then
         print*,'Error: Wrong Randel database for ',months(mois)
         error=1
      endif
      if(ibr.eq.2.and.mois.ne.07)then
         print*,'Error: Wrong Randel database for ',months(mois)
         error=1
      endif
c
...
c         print*,'Error: Apply GW Stress only for diurnal tides.'
c         error=1
c      endif
c
