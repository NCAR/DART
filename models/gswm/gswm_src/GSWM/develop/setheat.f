...
c       write(10, 101)
c	write(10,111) (x1O3(i),i=1,17)

	j=28
	do 9 i=1,27
	j=j-1

c       write(10, 100) pl(j),(d1O3(k,i),k=1,17)
...
c	write(10, 100) pl(j),(z1O3(k,i),k=1,17)
...
c       write(10, 301)
c	write(10, 311) (lO3(i),i=1,37)

	j=26
	do 449 i=1,26
	j=j-1
        iz=j*4
c       write(10, 300) iz,(d1O3(k,i),k=1,37)
  449  continue
