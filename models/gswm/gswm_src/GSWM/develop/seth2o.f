...
C_________________________________________________________________________
	...
	character*13 dchoice(4)
	character*12 schoice(4)
	character*13 dmfile
     ...
     +  sigma2,dah2o(37,41),zadh2o(37,41,3),sigma2a
        ...
        data dchoice/'h2o_jan.diurn','h2o_apr.diurn','h2o_jul.diurn',
     +             'h2o_oct.diurn'/

        data schoice/'h2o_jan.semi','h2o_apr.semi','h2o_jul.semi',
     +             'h2o_oct.semi'/
...
C
	...
	call surf1(37,41,xlh2o,zh2o,dh2o,37,zx1,zxm,zy1,zyn,zxy11,zxym1,
     +  zxy1n,zxymn,255,zdh2o,temp,sigma2,ierr)
