...
<P>
DART interface module for the Lorenz-84 model. The 16 public interfaces
...
Lorenz E. N., 1984:<br>
Irregularity: A fundamental property of the atmosphere.<br>
<i>Tellus</i>,&nbsp; <b>36A</b>, 98-110. 
<br><br>
...
lorenz-84, the variable 1 (x) is at 0.0, the variable 2 (y) at 1/3, and the 
variable 3 (z) at 2/3 on a cyclic [0, 1] domain.
...
<P>
A stub since lorenz-84 requires no clean up.
</P>
...
Values chosen here are 0 for x and z and 1 for y.
</P>
...
<H2>REFERENCES</H2>
<ol>
   <li>Lorenz, E.N., 1984: Irregularity: A fundamental property of the atmosphere. 
       <span style="font-style: italic;">Tellus</span>,
       <span style="font-weight: bold;">36A</span>, 98-110.</li>
</ol>
