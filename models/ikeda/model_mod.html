...
<P>
DART interface module for the Ikeda model. The 16 public interfaces
...
Interface written by <strong>Greg Lawson, CalTech</strong>. Thanks Greg!
<br />
<br />
<blockquote>"The initial conditions were generated by observing state 
variable 1 with an enormous (~1,000,000.0) observation error variance.
The observation was defined to be taken at day=0, seconds = 0. 
<em class=program>create_fixed_network_sequence</em> was run to create
a sequence with 3000 hourly observations starting at day=0, seconds =0.
...
<TR><TD> time_step_days </TD>
    <TD> integer </TD>
    <TD>Model advance time in days.
</TD></TR>

<TR><TD> time_step_seconds </TD>
    <TD> integer </TD>
    <TD>Model advance time in seconds.
</TD></TR>
