...
<TBODY valign=top>
<TR><TD>init_template_filename</TD>
...
<TR><TD>mpas_vars_nml</TD>
    ...
    <TD>The table that both specifies which MPAS-ATM variables will be
        ...
        <em class=file>assimilation_code/modules/observations/obs_kind_mod.f90</em> for known names.
...
<table width="100%" cellpadding="3" summary="description of grid cell variables">
...
<div class=indent1>
   MPAS files no longer beed to be converted to DART formated files, they
   can be read in directly from a input file list!
   <!--
...
<TABLE width=50% summary='list of required interface routines'>
...
<TABLE width=50% summary='list of interface routines unique to mpas'>
<TR><TD><em class=call>use model_mod, only : </em></TD>
...
<br />
<div class=routine>
<em class=call>call nc_write_model_atts(ncFileID, domainID)</em>
<pre>
integer, intent(in) :: <em class=code>ncFileID</em>
integer, intent(in) :: <em class=code>domainID</em>
</pre>
</div>
...
<TR><TD valign=top><em class=code>domainID</em></TD>
    <TD>Integer descriptor specifying the domain whose metadata should be written.</TD></TR>
...
<TABLE border=0 width=100% summary='list of files used by this module'>
