...
print*, 'values', state_vars_clamp%clamp_values(2,1)
call ok(state_vars_clamp%clamp_values(2,2) == 2.0_r8, "integer '2'")
print*, 'values', state_vars_clamp%clamp_values(2,2)
call ok(state_vars_clamp%clamp_values(3,1) == -4.0_r8, "integer '-4'")
print*, 'values', state_vars_clamp%clamp_values(3,1)
call ok(state_vars_clamp%clamp_values(3,2) == 3.0_r8, "integer '3'")
print*, 'values', state_vars_clamp%clamp_values(3,2)
