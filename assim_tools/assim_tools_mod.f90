...
subroutine obs_increment(ens, ens_size, obs, obs_var, obs_inc, slope, a, bias_ratio_out)
...
if(filter_kind == 1) then
   ...
   write(*, *) 'Illegal value of filter_kind in assim_tools namelist'
   stop
endif
...
subroutine obs_increment_eakf(ens, ens_size, obs, obs_var, obs_inc, slope, a, bias_ratio_out)
!========================================================================
!
...
! Form inflated ensemble
   ...
   inf_prior_var_inv = 1.0 / inf_prior_var
   new_var = 1.0 / (inf_prior_var_inv + inf_obs_var_inv)
...
subroutine obs_increment_particle(ens, ens_size, obs, obs_var, obs_inc, slope, a, bias_ratio_out)
!------------------------------------------------------------------------
!
...
subroutine obs_increment_enkf(ens, ens_size, obs, obs_var, obs_inc, slope, a, bias_ratio_out)
!========================================================================
...
subroutine obs_increment_kernel(ens, ens_size, obs, obs_var, obs_inc, slope, a, bias_ratio_out)
!========================================================================
...
if(a < 0.0) then
   write(*, *) 'THe prior_spread_correction algorithm only works with EAKF filters'
   write(*, *) 'Please do not select prior_spread_correction = .true. with other filters'
   stop
endif
