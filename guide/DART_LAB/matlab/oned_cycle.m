...
handles.ui_text_prior_ens_mean = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.052 0.852 0.273 0.065], ...
...
handles.ui_text_prior_cont_mean = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.052 0.822 0.273 0.065], ...
...
handles.ui_text_prior_ens_sd = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.052 0.762 0.273 0.065], ...
    'String', 'Prior Ens SD = ', ...
    'BackgroundColor', 'White', ...
    'ForegroundColor', atts.green, ...
    'FontUnits', 'normalized', ...
...
handles.ui_text_prior_cont_sd = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.052 0.732 0.273 0.065], ...
...
handles.ui_text_post_ens_mean = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.340 0.852 0.300 0.065], ...
...
handles.ui_text_post_cont_mean = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.340 0.822 0.300 0.065], ...
...
handles.ui_text_post_ens_sd = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.340 0.762 0.300 0.065], ...
...
handles.ui_text_post_cont_sd = uicontrol('Style', 'text', ...
    'Units', 'Normalized', ...
    'Position', [0.340 0.732 0.300 0.065], ...
...
set(handles.ui_text_prior_ens_mean          , 'String', 'Prior Ens Mean =       ');
set(handles.ui_text_prior_cont_mean          , 'String', 'Prior Cont Mean =       ');
set(handles.ui_text_prior_ens_sd            , 'String',   'Prior Ens SD =       ');
set(handles.ui_text_prior_cont_sd            , 'String',   'Prior Cont SD =       ');

set(handles.ui_text_post_ens_mean           , 'String', 'Posterior Ens Mean =       ');
set(handles.ui_text_post_cont_mean           , 'String', 'Posterior Cont Mean =       ');
set(handles.ui_text_post_ens_sd             , 'String',   'Posterior Ens SD =       ');
set(handles.ui_text_post_cont_sd             , 'String',   'Posterior Cont SD =       ');
    ...
    function button_create_new_ens_Callback(~,~)
        ...
        while ens_size < 100
            ...
            if(xt >= xlower && xt <= xupper && yt >= ylower && yt <= yupper)
                ...
                set(handles.ui_text_prior_ens_mean, 'String', str1);
                str1 = sprintf('Prior Ens SD = %.4f', prior_ens_sd);
                set(handles.ui_text_prior_ens_sd,   'String', str1);
...
%% -----------------------------------------------------------------------------
    ...
    function button_cycle_da_Callback (~, ~)
        ...
        set(handles.ui_text_prior_cont_mean, 'String', str1);
        str1 = sprintf('Prior Cont SD = %.4f', handles.prior_cont_sd);
        set(handles.ui_text_prior_cont_sd,   'String', str1);
