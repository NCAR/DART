...
<HTML>
<HEAD>
<TITLE>program create_obs_sequence</TITLE>
...
<H1>program <em class=program>create_obs_sequence</em></H1>
...
Then the program 
<a href="../create_fixed_network_seq/create_fixed_network_seq.html">create_fixed_network_seq</a>
...
created by the
<a href="../../../assimilation_code/programs/preprocess/preprocess.html">preprocess</a>
...
<H2>NAMELIST</H2>
<P>
This program does not use a namelist.
All user input is prompted for at the command line.
</P>
...
<H2>FILES</H2>
<UL>
   <LI>A file containing the output sequence is created.<br>
    (<em class=file>set_def.out</em> is the recommended name)</LI>
</UL>
