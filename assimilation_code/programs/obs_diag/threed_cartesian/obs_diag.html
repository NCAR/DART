...
<H1>PROGRAM <em class=program>obs_diag</em> (for observations that use the threed_cartesian location module)</H1>
...
<ol>
    ...
    <li>Replace namelist integer variable  <em class=code>debug</em> with logical 
        variable <em class=code>verbose</em> to control amount of run-time output.</li><br />
...
<TR><TD> hlevel </TD>
    ...
    <TD>Same, but for observations that have height(m) or depth(m) as the vertical
        coordinate. An example of defining the midpoints is:<br>
        <em class=code>hlevel = 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000,</em>
</TD></TR>
...
<TR><TD> hlevel_edges </TD>
    ...
    <TD>The edges defining the height (or depth) levels for the vertical binning.
        ...
        An example of defining the edges is:<br>
        <em class=code>hlevel_edges = 0, 1500, 2500, 3500, 4500, 5500, 6500,</em>
</TD></TR>
...
<TR><TD> xlim1 </TD>
    <TD> real, dimension(50) </TD>
    <TD> western extent of each of the regions.
</TD></TR>

<TR><TD> xlim2 </TD>
    <TD> real, dimension(50) </TD>
    <TD> eastern extent of each of the regions.
</TD></TR>

<TR><TD> ylim1 </TD>
    <TD> real, dimension(50) </TD>
    <TD> southern extent of the regions.
</TD></TR>

<TR><TD> ylim2 </TD>
    <TD> real, dimension(50) </TD>
    <TD> northern extent of the regions.
</TD></TR>
...
coordinate called 'surface' as opposed to 'hlevel' for the others in
this example).</li>
</ol>
...
<table width=95%>
<tr><td>In this example, we will be accumulating metrics for 30 days.
   The <em class=file>obs_diag_output.nc</em> file will have
