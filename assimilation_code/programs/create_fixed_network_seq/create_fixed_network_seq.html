...
<HTML>
<HEAD>
<TITLE>program create_fixed_network_seq</TITLE>
...
<H1>program <em class=program>create_fixed_network_seq</em></H1>
...
<a href="../../modules/observations/obs_sequence_mod.html#Namelist">obs_sequence_mod</a>.
</P>
...
<div class="top">[<a href="#">top</a>]</div><hr />
<H2>FILES</H2>
<UL><LI>Input observation sequence (set_def.out is standard).
    <LI>Output observation sequence (obs_seq.in is standard).
</UL>
