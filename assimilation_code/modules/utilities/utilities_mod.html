...
character(len=*), optional, intent(in) :: <em class=optionalcode>rev</em>
character(len=*), optional, intent(in) :: <em class=optionalcode>rdate</em>
</pre>
</div>
...
<P>
Writes the source name to both the logfileunit and to standard out.
The rev and revdate are deprecated as they are unsupported by git.
</P>
