...
<TR><TD>select_regression</TD>
    <TD>integer </TD>
    <TD>Selects the method for computing regression factor.
<UL style="list-style: none;">
<LI>1 = compute using sampling theory for any ensemble size. </LI>
<LI>2 = low order model format. Works from archived time mean or time
median regression files generated by low-order models like Lorenz-96. </LI>
<LI>3 = selects bgrid archived file. This is not currently supported in 
released versions.</LI>
</UL>
</TD></TR> 

<TR><TD>input_reg_file </TD>
    <TD>character(len=129)</TD>
    <TD>File name from which statistics are to be read for select_regression = 3.
</TD></TR>

<TR><TD>save_reg_diagnostics</TD>
    <TD>logical<em class="unit">&nbsp;</em></TD>
    <TD> True if regression diagnostics should be computed.
</TD></TR>

<TR><TD>reg_diagnostics_file </TD>
    <TD>character(len=129)<em class="unit">&nbsp;</em></TD>
    <TD>File name to which to write diagnostics.
</TD></TR>
