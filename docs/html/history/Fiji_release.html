...
<a name="TOP" id="TOP"></a>
<h1>Fiji</h1>
<h2>DART Fiji release documentation</h2>
<div class="attention">
<div class="title">
<p>Attention</p>
</div>
<p>Fiji is a prior release of DART. Its source code is available via the
<a href="https://github.com/NCAR/DART/tree/Fiji">DART repository on Github</a>.
...
<p>This release of the <a href="https://github.com/NCAR/DART/releases/tag/v2.0.0">
...
named <em class="file">DART</em> and will be approximately 14.2 Mb.
...
<h3 class="indent1">Building and Customizing the <code>mkmf.template</code> file</h3>
...
<p>The result (hopefully) is that four executables now reside in your
...
<h4 class="indent1">1. Integrate the L63 model for a 'long'
time.</h4>
...
<em class="program">create_obs_set_def</em> followed by <em class=
"program">create_obs_sequence</em>. After they are both run, it is
necessary to integrate the model with <em class=
"program">perfect_model_obs</em>.
<h4 class="indent1">1.1 Create an observation set definition.</h4>
<p><em class="program">create_obs_set_def</em> creates an
...
A <em class="file">True_State.nc</em> file is
