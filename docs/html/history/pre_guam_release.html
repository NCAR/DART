...
<p><a href="DART_pre_guam.tar.gz">The latest software release --
"pre_guam"</a>[22 Mb -- .tar.gz]</p>
...
<p>The DART source code is distributed as a compressed tar file.
<a href="DART_fiji.tar.gz">DART_fiji.tar.gz</a> [22347692 bytes].
When untarred, the source tree will begin with a directory named
<em class="file">DART</em> and will be approximately 105 Mb.
Compiling the code in this tree (as is usually the case) will
necessitate much more space.</p>
<div class="unix">gunzip <em class="file">DART_fiji.tar.gz</em><br>
tar -xvf <em class="file">DART_fiji.tar</em><br></div>
...
<div class="routine"># Makefile template for PGI f90<br>
FC = pgf90<br>
CPPFLAGS =<br>
...
-L/usr/local/udunits-1.11.7/lib -ludunits<br>
LIST = -Mlist<br>
<br>
...
"program">create_obs_set_def</em>, <em class=
...
"file">input.nml.mkmf</em> file. It is not supposed to compile
anything:</p>
<div class="unix">csh mkmf_create_obs_set_def<br>
mv input.nml.mkmf input.nml.create_obs_set_def<br>
make</div>
<p>The first command generates an appropriate <em class=
"file">Makefile</em> and the <em class="file">input.nml.mkmf</em>
file. The second saves the example namelist to a unique name (the
next DART release will do this automatically -- no harm is done by
omitting this step) and the last command results in the compilation
of a series of Fortran90 modules which ultimately produces an
executable file: <em class="program">create_obs_set_def</em>.
Should you need to make any changes to the <em class=
"file">DART/mkmf/mkmf.template</em>, you will need to regenerate
the <em class="file">Makefile</em>. A series of object files for
each module compiled will also be left in the work directory, as
some of these are undoubtedly needed by the build of the other DART
components. You can proceed to create the other three programs
needed to work with L63 in DART as follows:</p>
...
"file">Makefile</em>, and try again.<br>
<br>
...
<tr>
<td><em class="program">create_obs_set_def</em></td>
...
<div class="unix">
<pre>
[thoar@ghotiol work]$ <em class="input">./create_obs_sequence</em>
 Registering module :
 $source$
 $revision: 3169 $
 $date: 2007-12-07 16:40:53 -0700 (Fri, 07 Dec 2007) $
...
<div class="routineIndent1">&amp;perfect_model_obs_nml<br>
   async = 0,<br>
   obs_seq_in_file_name = "obs_seq.in",<br>
   obs_seq_out_file_name = "obs_seq.out",<br>
   start_from_restart = .false.,<br>
   output_restart = <em class=
"changed">.true.</em>,<br>
...
&amp;end<br></div>
<br>
For the moment, only two namelists warrant explanation. Each
...
"program">create_obs_sequence</em>, i.e. the 'observation sequence
definition' file.</td>
</tr>
<tr>
...
"changed">.true.</em>,<br>
   ...
   num_output_ens_members = <em class=
"changed">20</em>,<br>
   output_interval = 1,<br>
   num_groups = 1,<br>
...
<div class="unix">filter<br>
cp perfect_restart perfect_ics<br>
cp filter_restart filter_ics</div>
...
"program">create_obs_set_def</em> to generate an observation set in
...
<td># Number of observations in set (x, y, and z)</td>
</tr>
<tr>
...
<tr>
<td><em class="input">1</em></td>
<td># First ob is identity observation of state variable 1 (x)</td>
</tr>
<tr>
<td><em class="input">1.0</em></td>
...
<td># Second is identity observation of state variable 2 (y)</td>
</tr>
<tr>
<td><em class="input">1.0</em></td>
<td># Variance of third ob</td>
</tr>
<tr>
<td><em class="input">3</em></td>
<td># Identity ob of third state variable (z)</td>
</tr>
</table>
<p class="indent1">Now, generate an observation sequence definition
by running <em class="program">create_obs_sequence</em> with the
...
<div class="routineIndent1">&amp;filter_nml<br>
   async = 0,<br>
   ens_size = 20,<br>
