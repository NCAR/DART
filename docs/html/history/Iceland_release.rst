...
<P>
<A HREF="/DAReS/DART/DART_download">The latest software release -- "Iceland".</A>
</P>

<P>The <b>Iceland</b> release provides several new models and has a greatly expanded capability for 
...
<P>
The Iceland release has also been tested with more compilers in an attempt to 
...
203 Mb. Compiling the code in this tree (as is usually the case) will
necessitate much more space.
</P>

<div class=unix>
   gunzip <em class=file>DART_iceland.tar.gz</em><BR>
   tar -xvf <em class=file>DART_iceland.tar</em><BR>
</div>
