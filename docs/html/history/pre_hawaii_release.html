...
<HTML>
<HEAD>
<TITLE>DART "pre_hawaii release" Documentation</TITLE>
...
<H1>DART "pre_hawaii release" Documentation</H1>
...
<P>
<A HREF="/pub/DART/DART_pre_hawaii.tar.gz">The latest software release -- "pre_hawaii"</A>[43 Mb -- .tar.gz]
</P>
...
<div class=unix>
   gunzip <em class=file>DART_pre_hawaii.tar.gz</em><BR>
   tar -xvf <em class=file>DART_pre_hawaii.tar</em><BR>
</div>
...
<em class=file>DART/mkmf/mkmf.template</em>, (<i>i.e.</i> change compile options)
...
DART/assimilation_code/modules/observations/obs_sequence_mod.html<BR> 
<BR> 
...
&nbsp;&nbsp;&nbsp;obs_sequence_out_name = "obs_seq.out",<BR>
...
<TR><TD><em class=input>1</em></TD>
    <TD># Number of sets</TD></TR>
<TR><TD><em class=input>3</em></TD>
    <TD># Number of observations in set (x, y, and z)</TD></TR>
<TR><TD><em class=input>1.0</em></TD>
    <TD># Variance of first observation</TD></TR>
<TR><TD><em class=input>1</em></TD>
    <TD># First ob is identity observation of state variable 1 (x)</TD></TR>
<TR><TD><em class=input>1.0</em></TD>
    <TD># Variance of second observation </TD></TR>
<TR><TD><em class=input>2</em></TD>
    <TD># Second is identity observation of state variable 2 (y)</TD></TR>
<TR><TD><em class=input>1.0</em></TD>
    <TD># Variance of third ob </TD></TR>
<TR><TD><em class=input>3</em></TD>
    <TD># Identity ob of third state variable (z)</TD></TR>
</TABLE>
...
<em class=file>DART/matlab </em> directory. They are reliant on the public-domain 
...
<P>Once you can access the <em class=program>getnc</em> function from within Matlab,
   ...
   the DART/matlab scripts to the matlabpath. Keep in mind the location of the netcdf
