...
<p><a href="/pub/DART/DART_pre_hawaii.tar.gz">The latest software
release -- "pre_hawaii"</a>[43 Mb -- .tar.gz]</p>
...
directory named <em class="file">DART</em> and will be
approximately 105 Mb. Compiling the code in this tree (as is
usually the case) will necessitate much more space.</p>
<div class="unix">gunzip <em class=
"file">DART_pre_hawaii.tar.gz</em><br>
tar -xvf <em class="file">DART_pre_hawaii.tar</em><br></div>
...
"file">DART/mkmf/mkmf.template</em>, (<i>i.e.</i> change compile
options) you will need to regenerate the <em class=
...
<div class="unix">csh   mkmf_create_fixed_network_seq<br>
make<br>
...
the <em class="file">DART/mkmf/mkmf.template</em>, recreate the
<em class="file">Makefile</em>, and try again.<br>
<br>
...
DART/assimilation_code/programs/create_obs_sequence/create_obs_sequence.html
and
...
&amp;utilities_nml<br>
   TERMLEVEL = 1<br>
   logfilename = 'dart_log.out' /<br></div>
<br>
...
conditions.</h3>
<p>The set of initial conditions for a 'perfect model' experiment
is created by taking the spun-up state of the model (available in
<em class="file">perfect_restart</em>), running <em class=
"program">perfect_model_obs</em> to generate the 'true state' of
the experiment and a corresponding set of observations, and then
feeding the same initial spun-up state and resulting observations
into <em class="program">filter</em>.<br>
<br>
...
"changed">"perfect_ics"</em>,<br>
   ...
   num_output_state_members = <em class=
"changed">20</em>,<br>
   num_output_obs_members = <em class=
"changed">20</em>,<br>
   output_interval = 1,<br>
   num_groups = 1,<br>
