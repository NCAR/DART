...
<p><a href="/DAReS/DART/DART_download">The "pre_j"
distribution.</a></p>
<p>The <b>pre_j</b> release provides several new models and has a
...
HURRAY!</p>
<p>The pre_j release has also been tested with more compilers in an
...
"file">DART_pre_j.tar.gz</em><br>
tar -xvf <em class="file">DART_pre_j.tar</em><br></div>
