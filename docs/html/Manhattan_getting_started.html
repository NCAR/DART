...
Website</a> <a href="../../docs/DART_LAB/DART_LAB.html">local file</a>
in the
...
are:
&nbsp;<em class=file>DART/build_templates</em>,
&nbsp;<em class=file>DART/models/lorenz_63/work</em>, and 
&nbsp;<em class=file>DART/diagnostics/matlab</em> (but only for analysis).
</p>
...
<a href="https://www.gfdl.noaa.gov/~vb/mkmf.html#mkmf">
...
in the <em class=file>DART/build_templates/</em> directory and have names with
...
<em class=file>DART/build_templates/mkmf.template</em>, 
...
<p>
This created <em class=file>DART/observations/forward_operators/obs_def_mod.f90</em> from
<em class=file>DART/assimilation_code/modules/observations/DEFAULT_obs_kind_mod.F90</em> and several other
modules. <em class=file>DART/assimilation_code/modules/observations/obs_kind_mod.f90</em> was created similarly.
...
Edit the <em class=file>DART/build_templates/mkmf.template</em>,
...
<a href="../../assimilation_code/programs/filter/filter.html#Inflation">local file</a>.
</p>
