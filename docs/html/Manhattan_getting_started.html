...
<a href="#GettingStarted">Getting Started</a> / <a href=
"#Installation">Installation</a> / <a href="#Legalese">Terms of
Use</a> 
<!--==================================================================-->
...
code compile cleanly.<br>
<br>
DART uses the <a href=
"https://www.unidata.ucar.edu/downloads/netcdf/index.jsp">NetCDF</a>
...
<strong>ncview</strong>: DART users have used <a href=
"http://meteora.ucsd.edu/~pierce/ncview_home_page.html">ncview</a>
to create graphical displays of output data fields. 
<!--The 2D rendering is
good for 'quick-look' type uses, but I wouldn't want to publish with it.-->
<br>
<br>
<strong>NCO</strong>: The <a href=
"http://nco.sourceforge.net">NCO</a> tools are able to perform
operations on NetCDF files like concatenating, slicing, and
dicing.<br>
<br>
<strong>Matlab</strong>®: A set of <a href=
"http://www.mathworks.com/">Matlab®</a> scripts designed to produce
graphical diagnostics from DART. 
<!--NetCDF output files are also part
of the DART project.--><br>
<br>
<strong>MPI</strong>: The DART system includes an MPI option. MPI
...
on a single processor, you need read no further about MPI.<br>
<br>
...
presentation slides Website <a href=
"../../docs/DART_LAB/DART_LAB.html">local file</a> in the
<em class="file">DART_LAB</em> directory, and then take the
...
<p><strong>HURRAY</strong>! The DART source code is now distributed
through an anonymous Subversion server! The <strong>big</strong>
advantage is the ability to patch or update existing code trees at
your discretion. Subversion (the client-side app is
'<strong>svn</strong>') allows you to compare your code tree with
one on a remote server and selectively update individual files or
groups of files. Furthermore, now everyone has access to any
version of any file in the project, which is a huge help for
developers. I have a brief summary of the svn commands I use most
posted at: <a href=
"http://www.image.ucar.edu/~thoar/svn_primer.html">http://www.image.ucar.edu/~thoar/svn_primer.html</a></p>
<p>The resources to develop and support DART come from our ability
to demonstrate our growing user base. We ask that you register at
our download site <a href=
"http://www.image.ucar.edu/DAReS/DART/DART_download">http://www.image.ucar.edu/DAReS/DART/DART_download</a>
and promise that the information will only be used to notify you of
new DART releases and shown to our sponsers in an aggregated form:
"Look - we have three users from Tonawanda, NY". After filling in
the form, you will be directed to a website that has instructions
on how to download the code.</p>
<p>svn has adopted the strategy that "disk is cheap". In addition
to downloading the code, it downloads an additional copy of the
code to store locally (in hidden .svn directories) as well as some
administration files. This allows svn to perform some commands even
when the repository is not available. It does double the size of
the code tree for the initial download, but then future updates
download just the changes, so they usually happen very quickly.</p>
<p>If you follow the instructions on the download site, you should
wind up with a directory named <em class="file">DART</em>.
...
are:  <em class="file">DART/build_templates</em>,
 <em class="file">DART/models/lorenz_63/work</em>, and
 <em class="file">DART/diagnostics/matlab</em> (but only for
analysis).</p>
<!--==================================================================-->
...
<a href="https://www.gfdl.noaa.gov/~vb/mkmf.html#mkmf">the FMS mkmf
description</a>.<br>
One of the benefits of using <em class="program">mkmf</em> is that
...
exists in the <em class="file">DART/build_templates/</em> directory
and have names with extensions that identify the compiler, the
...
NetCDF library and modules.<br>
<br>
If you have MPI installed on your system <em class="code">MPIFC,
...
<div class="unix">cd DART/models/lorenz_63/work<br>
ls -1</div>
<p>With the result:</p>
<pre>
filter_input.cdl
...
<p>There are seven <em class="file">mkmf_</em><em class=
...
<div class="unix">csh mkmf_preprocess<br>
make</div>
...
the <em class="file">DART/build_templates/mkmf.template</em>, you
will need to regenerate the <em class="file">Makefile</em>.<br>
<br>
...
"file">DART/observations/forward_operators/obs_def_mod.f90</em>
from <em class=
"file">DART/assimilation_code/modules/observations/DEFAULT_obs_kind_mod.F90</em>
and several other modules. <em class=
"file">DART/assimilation_code/modules/observations/obs_kind_mod.f90</em>
was created similarly. Now we can build the rest of the
project.<br>
<br>
...
<div class="unix">csh mkmf_create_obs_sequence<br>
make<br>
...
"file">DART/build_templates/mkmf.template</em>, recreate the
<em class="file">Makefile</em>, and try again.</p>
...
matter)</p>
<div class="unix">cp input.nml.perfect_model_obs_default
input.nml<br></div>
...
<br>
<br>
<div class="unix">cp perfect_restart perfect_ics<br>
./perfect_model_obs</div>
...
<div class="indent1">cp input.nml.filter_default
input.nml<br></div>
...
"file">input.nml</em>.<br>
<br>
<em>HINT:</em> if you used <em class="program">svn</em> to get the
...
"../../assimilation_code/programs/filter/filter.html#Inflation">local
file</a>.</p>
<!--==================================================================-->
