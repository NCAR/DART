...
Matlab&reg; (to see how to configure your environment to use Matlab 
and the DART diagnostics, see the documentation for 
<a href="http://www.image.ucar.edu/DAReS/DART/DART2_Documentation.php#configure_matlab">Configuring&nbsp;Matlab&reg;&nbsp;for&nbsp;netCDF&nbsp;&amp;&nbsp;DART</a>).
